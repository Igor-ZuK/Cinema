...
class Movie(models.Model):
	...
	year=models.PositiveSmallIntegerField("Дата выхода",default=2020, db_index=True)
	country=models.CharField("Страна", max_length=50)
	directors=models.ManyToManyField(Actor, verbose_name="режиссёр", related_name="film_director")
	actors=models.ManyToManyField(Actor, verbose_name="актёр", related_name="film_actors")
